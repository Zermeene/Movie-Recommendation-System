...
def main_app():
    ...
    last_deleted_document = None  # To store last deleted movie for undo
    ...
    def show_movies_by_genre(genre):
        ...
        for doc in docs:
            ...
            tree.insert('', 'end', values=(
                doc.id,  # This contains the document ID
                data.get('title', ''),
                data.get('genre', ''),
    ...
    def add_to_my_list():
        ...
        for item in selected_items:
            ...
            movie_id = movie_data[0]  # Assuming the first column is ID
    ...
    def undo_delete():
        ...
        if last_deleted_document:
            add_document('my_list', last_deleted_document)  # Add back the document
    ...
    genre_var.set(genres[0])  # Set default genre
    ...
    # Add entry for searching movies
